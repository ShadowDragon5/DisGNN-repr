...
from counterexamples.utils.basic_utils import (
    PointCloud2nxGraph,
    TestIsomorphism,
    sample,
)
...
if args.reg == "12":
    ...
    from counterexamples.utils.cube_reg_8 import (
        generate_cube_plus_reg_8,
    ...
    from counterexamples.utils.cube_cube import (
        generate_cube_plus_cube,
...
if __name__ == "__main__":
    ...
    for policy in sample_policys:
        ...
        Gl, Gr = (
            PointCloud2nxGraph(PCl, initial_labels=None),
            PointCloud2nxGraph(PCr, initial_labels=None),
        )
        ...
        distinguisable, labels_l_dict, labels_r_dict, _ = CR_E(
            Gl=Gl, Gr=Gr, verbose=verbose
        )
        ...
        if is_counterexample:
            ...
            hist_l, hist_r = (
                get_label_histogram(labels_l_dict),
                get_label_histogram(labels_r_dict),
            )
